...
public interface IITTrack extends iTunes.def.IITObject {
    /**
     * Delete this track.
     */
    @VTID(15)
     ...
     */
    @VTID(17)
    iTunes.def.IITArtwork addArtworkFromFile(
    ...
    /**
     * The user rating of the track (0 to 100).
     */
    @VTID(56)
    int rating();
     ...
     */
    @VTID(71)
    iTunes.def.IITArtworkCollection artwork();

    @VTID(71)
    @ReturnValue(defaultPropertyThrough={iTunes.def.IITArtworkCollection.class})
    iTunes.def.IITArtwork artwork(
        int index);
